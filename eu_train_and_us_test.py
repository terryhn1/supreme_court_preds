...
if __name__ == "__main__":
    ...
    train_loader, test_loader = data.BucketIterator.splits((eu_data, us_data), batch_size=10, device = device, sort_key = lambda x: len(x.text), shuffle = True, sort_within_batch = True, sort = False)
