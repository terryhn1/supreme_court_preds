...
if __name__ == "__main__":
    ...
    train_loader, test_loader = data.BucketIterator.splits((us_train, eu_test), batch_size=32, device = device, sort_key = lambda x: len(x.text), shuffle = True, sort_within_batch = True, sort = False)
